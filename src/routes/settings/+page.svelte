    ...
    <details class="section">
      ...
      <div class="card">
        ...
        <div class="setting-row">
          ...
          <button class="toggle" class:on={settings.download.auto_download_on_paste} onclick={() => toggleBool("download", "auto_download_on_paste", settings!.download.auto_download_on_paste)} role="switch" aria-checked={settings.download.auto_download_on_paste} aria-label={$t('settings.download.auto_download_on_paste')}><span class="toggle-knob"></span></button>
        </div>
      </div>
    </details>
